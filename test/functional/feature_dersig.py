...
class BIP66Test(NEOMTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # neomd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and neomd produces more specific reject
            # reasons.
