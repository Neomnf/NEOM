...
"""Verify that starting neom with -h works as expected."""

from test_framework.test_framework import NEOMTestFramework
from test_framework.util import assert_equal

class HelpTest(NEOMTestFramework):
    ...
    def run_test(self):
        self.log.info("Start neom with -h for help text")
        ...
        self.log.info("Start neom with -version for version information")
        ...
        self.log.info("Start neomd with -fakearg to make sure it does not start")
