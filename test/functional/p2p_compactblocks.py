...
# TestP2PConn: A peer we use to send messages to neomd, and store responses.
...
class CompactBlocksTest(NEOMTestFramework):
    ...
    # This test actually causes neomd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that neomd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for neomd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # neomd will not send blocktxn responses for blocks whose height is
