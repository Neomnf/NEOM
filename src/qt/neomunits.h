...
#ifndef NEOM_QT_NEOMUNITS_H
#define NEOM_QT_NEOMUNITS_H
...
/** NEOM unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NEOMUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NEOMUnits(QObject *parent);

    /** NEOM units.
      @note Source: https://en.neom.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NEOM,
...
typedef NEOMUnits::Unit NEOMUnit;

#endif // NEOM_QT_NEOMUNITS_H
