    ...
    mapper(0)
{
    ...
    ui->neomAtStartup->setToolTip(ui->neomAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->neomAtStartup->setText(ui->neomAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openNEOMConfButton->setToolTip(ui->openNEOMConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new NEOMUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->neomAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNEOMConfButton_clicked()
{
