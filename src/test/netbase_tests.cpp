...
{
    BOOST_CHECK(TestSplitHost("www.neomcore.org", "www.neomcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.neomcore.org]", "www.neomcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.neomcore.org:80", "www.neomcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.neomcore.org]:80", "www.neomcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:21122", "127.0.0.1", 21122));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:21122", "127.0.0.1", 21122));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:21122", "::ffff:127.0.0.1", 21122));
    BOOST_CHECK(TestSplitHost("[::]:21122", "::", 21122));
    BOOST_CHECK(TestSplitHost("::21122", "::21122", -1));
    BOOST_CHECK(TestSplitHost(":21122", "", 21122));
    BOOST_CHECK(TestSplitHost("[]:21122", "", 21122));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:21122", "127.0.0.1:21122"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:21122", "[::]:21122"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
