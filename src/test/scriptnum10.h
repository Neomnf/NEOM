...
#ifndef NEOM_TEST_SCRIPTNUM10_H
#define NEOM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from NEOM Core 0.10.0, for cross-comparison.
 */
public:
