/* src/config/neom-config.h.  Generated from neom-config.h.in by configure.  */
/* src/config/neom-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NEOM_CONFIG_H

#define NEOM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The NEOM Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "NEOM Core"
...
#define PACKAGE_BUGREPORT "https://github.com/Neomnf/NEOM/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NEOM Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NEOM Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "neom"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://neomcore.org/"
