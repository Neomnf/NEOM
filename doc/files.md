...
* neom.conf: contains configuration settings for neomd or neom-qt
* neomd.pid: stores the process id of neomd while running
...
* debug.log: contains debug information and general logging generated by neomd or neom-qt
