...
This document provides guidelines for internationalization of the NEOM Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `neom_en.ts` remains unchanged.
